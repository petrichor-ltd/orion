...
const translations = {
  zh: {
    ...
    hero: {
      title: "把香氣反應，變成可交付的腦波證據。",
      body:
        "Orion 將 Muse EEG、六款香氣樣本、Android 測試流程與雲端研究紀錄整合成一套可展示、可試測、可交付報告的產品。從第一次會議開始，就能看見導入路徑。",
    },
    proof: {
      device: "硬體與香氣套組完整",
      protocol: "個人基準對照流程",
    ...
    proofStrip: {
      deviceLabel: "完整套組",
      deviceTitle: "看得到產品，不只看得到概念",
      deviceBody: "硬體、香氣樣本、測試介面與報告輸出都能在同一套展示裡呈現。",
      protocolLabel: "測試流程",
      protocolTitle: "從基準到嗅聞，流程清楚可重複",
      protocolBody: "每次測試都保留相同節奏，降低主觀體驗難以比較的問題。",
      recordsLabel: "結果輸出",
      recordsTitle: "分數、建議、報告同步形成",
      recordsBody: "測試結束不是只得到一個數字，而是留下能討論的資料頁面。",
      demoLabel: "推進狀態",
      demoTitle: "可預約展示",
      demoBody: "適合用一次展示快速確認場域、試測、合作與下一步節奏。",
    },
    problem: {
      kicker: "一次測試的商業價值",
      title: "把嗅聞體驗，壓縮成可以推進決策的四個結果。",
      body:
        "香氣產品最難被放大的地方，是效果常停在感覺。Orion 把現場測試、腦波指標、香氣建議與報告交付收斂在同一個流程，讓每一次展示都能直接進入下一輪討論。",
      point1Title: "現場完成測試",
      point1Body: "受測者從基準、嗅聞到休息都在 Android 流程中完成，展示不再停留於口頭說明。",
      point2Title: "找出推薦香氣",
      point2Body: "六款實際樣本可被放進同一套比較邏輯，快速形成推薦、信心提示與後續方向。",
      point3Title: "量化腦波反應",
      point3Body: "SRI/ARI 回到個人基準比較，讓香氣反應能被展示、比較與累積。",
      point4Title: "交付可帶走報告",
      point4Body: "結果可形成 PDF 與雲端研究紀錄，讓會後仍能延續產品、研究與合作討論。",
    },
    thesis: {
      kicker: "結果報告",
      title: "測試結束後，不只得到分數，也得到交付的報告。",
      body:
        "Orion 的價值不在單次體驗，而是把嗅聞、腦波、評分、建議與 PDF 報告接成可複製的產品流程。展示現場可以直接從一份結果談導入、資料累積與未來擴張。",
    ...
    session: {
      ...
      title: "一次測試，從基準到報告。",
      body:
        "將現場最需要被看懂的三件事放在同一個互動流程：測試能不能跑、指標能不能解讀、結果能不能交付。",
    ...
    workflow: {
      title: "四步完成，留下可討論的結果。",
      body: "每一步都對應一個可展示的產品能力，讓流程更短，交付更明確。",
    },
    step1: {
      title: "連接 Muse",
  ...
  en: {
    ...
    hero: {
      title: "Turn fragrance response into deliverable EEG evidence.",
      body:
        "Orion combines Muse EEG, six aroma samples, Android-guided testing, and cloud research records into one product that can be demonstrated, tested, and reported from the first conversation.",
    },
    proof: {
    ...
    proofStrip: {
      ...
      deviceTitle: "A visible product, not only a concept",
      deviceBody: "Hardware, aroma samples, testing interface, and report output sit inside one demonstration.",
      protocolLabel: "Test flow",
      protocolTitle: "From baseline to exposure, repeatably",
      protocolBody: "Each session follows the same rhythm, making subjective fragrance experience easier to compare.",
      recordsLabel: "Result output",
      recordsTitle: "Score, recommendation, and report together",
      recordsBody: "A session ends with a discussion-ready result page, not only a number.",
      demoLabel: "Next step",
      demoTitle: "Demo-ready",
      demoBody: "Use one demo to align on setting, trial design, partnership, and next steps.",
    },
    problem: {
      kicker: "Commercial value in one session",
      title: "Compress fragrance experience into four decision-ready outcomes.",
      body:
        "The hardest part of scaling fragrance products is that effect often stays subjective. Orion compresses on-site testing, EEG indicators, aroma recommendation, and report delivery into one flow that moves directly into the next conversation.",
      point1Title: "Run the test on site",
      point1Body: "Baseline, exposure, and rest are handled in the Android flow, so the demo does not rely on verbal explanation.",
      point2Title: "Find the recommended aroma",
      point2Body: "Six real samples enter one comparison logic, producing recommendations, confidence notes, and next directions.",
      point3Title: "Quantify EEG response",
      point3Body: "SRI/ARI returns to a personal baseline, making fragrance response showable, comparable, and accumulative.",
      point4Title: "Deliver a report",
      point4Body: "Results become a PDF and cloud research record, extending product, research, and partnership discussion after the meeting.",
    },
    thesis: {
      kicker: "Result report",
      title: "After a session, teams receive more than a score. They receive a report they can use.",
      body:
        "Orion's value is not a single experience. It connects smelling, EEG capture, scoring, recommendations, and PDF reporting into a repeatable product workflow, so demos can move from one result into deployment, data accumulation, and expansion.",
    ...
    session: {
      kicker: "Product demo",
      title: "One test, from baseline to report.",
      body:
        "The interaction keeps the three things that matter in the room: the test can run, the indicators can be read, and the result can be delivered.",
    ...
    workflow: {
      title: "Four steps, one discussion-ready result.",
      body: "Each step maps to a demonstrable product capability, keeping the flow shorter and the deliverable clearer.",
    },
    step1: {
      title: "Connect Muse",
