...
const translations = {
  zh: {
    ...
    proofStrip: {
      deviceLabel: "完整套組",
      deviceTitle: "設備、香氣、App、報告一次到位",
      deviceBody: "開場就看得到完整產品面，減少抽象技術說明。",
      protocolLabel: "測試流程",
      protocolTitle: "從基準到嗅聞，每段可重複",
      protocolBody: "同一套節奏讓香氣體驗不只停在感覺，而能被比較。",
      recordsLabel: "結果輸出",
      recordsTitle: "推薦、分數、報告同步形成",
      recordsBody: "結束當下就能展示重點結果，延續會後討論。",
      demoLabel: "導入下一步",
      demoTitle: "展示後可直接安排試測",
      demoBody: "快速確認場域、樣本與合作節奏。",
    },
    problem: {
      kicker: "從展示到試測",
      title: "一次現場測試，看到產品能不能被採用。",
      body:
        "Orion 把硬體、流程、指標與報告放在同一條路徑。現場不用先相信敘事；戴上 Muse、完成嗅聞、看到分數與報告，就能判斷下一步試測價值。",
      point1Title: "完整跑完",
      point1Body: "基準、嗅聞、休息與完成狀態由 Android 引導，現場能清楚看到流程成熟度。",
      point2Title: "六款香氣比較",
      point2Body: "同一套流程比較六款實際樣本，快速形成推薦排序、信心提示與後續樣本方向。",
      point3Title: "量化腦波反應",
      point3Body: "SRI/ARI 以個人基準對照，讓主觀嗅聞轉成可展示、可比較、可累積的資料。",
      point4Title: "報告可交付",
      point4Body: "PDF 與雲端紀錄讓會後討論有共同文件，方便接續試測、研究與導入評估。",
    },
    thesis: {
      kicker: "結果報告",
    ...
    session: {
      ...
      title: "一次測試，從基準到報告。",
      body:
        "用互動展示看見一場測試如何從基準、嗅聞、腦波訊號走到分數與保存。節奏短、重點清楚，適合展示現場快速對齊。",
    ...
    workflow: {
      title: "四步完成，交付可帶走的結果。",
      body: "連線、測試、評分、同步各自對應可驗證的產品能力；流程越短，越容易安排試測與場域導入。",
    },
    step1: {
      title: "連接 Muse",
  ...
  en: {
    ...
    proofStrip: {
      ...
      deviceTitle: "Device, aromas, app, and report in one view",
      deviceBody: "The full product surface is visible from the first minute.",
      protocolLabel: "Test flow",
      protocolTitle: "Baseline to exposure, repeatable by design",
      protocolBody: "A consistent rhythm turns fragrance experience into comparable data.",
      recordsLabel: "Result output",
      recordsTitle: "Recommendation, score, and report together",
      recordsBody: "The end of a session produces material for the next conversation.",
      demoLabel: "Next step",
      demoTitle: "Demo to trial without a reset",
      demoBody: "Align quickly on setting, samples, and collaboration rhythm.",
    },
    problem: {
      kicker: "From demo to trial",
      title: "One on-site session shows whether the product can be adopted.",
      body:
        "Orion puts hardware, workflow, indicators, and reporting on one path. Teams do not need to trust the story first: wear Muse, complete the session, see the score and report, then decide the value of the next trial.",
      point1Title: "Run end to end",
      point1Body: "Baseline, exposure, rest, and completion states are guided by Android, making process maturity visible on site.",
      point2Title: "Compare six aromas",
      point2Body: "Six real samples run through one comparison logic to form ranking, confidence notes, and next sample direction.",
      point3Title: "Quantify EEG response",
      point3Body: "SRI/ARI compares against a personal baseline, turning subjective smell response into showable, comparable, accumulative data.",
      point4Title: "Deliver the report",
      point4Body: "PDF and cloud records give the follow-up discussion a shared artifact for trials, research, and adoption review.",
    },
    thesis: {
    ...
    session: {
      ...
      body:
        "The interactive demo shows how one session moves from baseline and aroma exposure to EEG signal, score, and saved record. Short rhythm, clear focus, ready for on-site alignment.",
    ...
    workflow: {
      title: "Four steps, one deliverable result.",
      body: "Connection, testing, scoring, and sync each map to a verifiable product capability. The shorter the flow, the easier it is to plan field trials and adoption.",
    },
    step1: {
      title: "Connect Muse",
